...
const presets = {
  preset1: {
    "channels": [
      {
        "triggers": [1, 6, 9, 14, 17, 22, 25, 30, 33, 38, 41, 46, 49, 54, 57, 62, 63],
        "mute": false,
        "toggleMuteSteps": [],
      ...
      {
        "triggers": [3, 7, 11, 15, 19, 23, 27, 31, 35, 39, 43, 47, 51, 55, 59, 63, 64],
        "mute": false,
        "toggleMuteSteps": [],
